...
class StellarPopulation(object):
    ...
    :param pmetals: (default: 2.0)
       ...
       linear units (i.e., :math:`z_\odot = 0.019`).  As of FSPS r191
       using a negative value will result in smoothing of the SSPs by
       a three-point triangular kernel before linear interpolation (in
       logZ) to the requested metallicity.
    ...
    def __init__(self, compute_vega_mags=True, zcontinuous=0,
                 **kwargs):
